    ...
    try {
        ...
        html += `
            ...
            <div class="basis-2/4">
                ...
                <div class="w-[360px] lg:w-[540px] flex gap-2">
                    <div
                        class="basis-1/4 h-[60px] lg:h-[95px] border rounded-lg hover:cursor-pointer overflow-hidden hover:border-primary ">
                        <img src="${data.image_pr.image_pr_2}" class="w-full h-full object-cover productPage_thumbnail"
                            alt="">
                    </div>
                    <div
                        class="basis-1/4 h-[60px] lg:h-[95px] border rounded-lg hover:cursor-pointer overflow-hidden hover:border-primary ">
                        <img src="${data.image_pr.image_pr_3}" class="w-full h-full object-cover productPage_thumbnail"
                            alt="">
                    </div>
                    <div
                        class="basis-1/4 h-[60px] lg:h-[95px] border rounded-lg hover:cursor-pointer overflow-hidden hover:border-primary ">
                        <img src="${data.image_pr.image_pr_4}"
                            class="w-full h-full object-cover productPage_thumbnail" alt="">
                    </div>
                    <div
                        class="basis-1/4 h-[60px] lg:h-[95px] border rounded-lg hover:cursor-pointer overflow-hidden hover:border-primary ">
                        <img src="${data.image_pr.image_pr_5}" class="w-full h-full object-cover productPage_thumbnail"
                            alt="">
                    </div>
                </div>
            </div>
...
//# sourceMappingURL=admin_product.3d214d75.js.map
