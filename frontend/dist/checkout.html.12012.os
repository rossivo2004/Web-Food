...
<head>
    ...
    <link rel="stylesheet" href="/admin_category.2a1881ae.css">
    <link rel="stylesheet" href="/admin_category.4a94d384.css">
...
<body>
    <div class="bg-gray-100">
        <header class="z-10 fixed lg:relative w-full top-0">
            <div>
                <div class="header_top h-10 w-full border-b-[1px] hidden lg:flex justify-between items-center font-bold text-sm px-40">
                    <div class="hd_phone ">
                        <p>0362654199</p>
                    </div>
                    <div>
                        <p class="text-primary">Miễn phí vận chuyển cho đơn từ 200.000 VND</p>
                    </div>
                    <div>
                        <div class="">
                            <a href="" class="hover:text-secondary">Đăng kí</a>
                            <span>|</span>
                            <a href="" class="hover:text-secondary">Đăng nhập</a>
                        </div>
                    </div>
                </div>
                <div class="header_center bg-white lg:px-40 px-6 flex items-center justify-between w-full h-16 lg:h-24">
                    <a href="" class="hd_logo">
                        <img src="https://images.pexels.com/photos/19202326/pexels-photo-19202326/free-photo-of-dolomite-y.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" class="h-14 w-14 object-cover">
                    </a>
                    <div class="hd_search hidden lg:block">
                        <form class="relative">
                            <span>
                                <input type="text" class="w-[460px] h-12 rounded-lg pl-5 pr-10 outline-0 border-radius border" placeholder="Search...">
                            </span>
                            <button class="absolute top-[14px] right-[10px] hover:text-secondary">
                                <i class="fa-solid fa-magnifying-glass text-xl"></i>
                            </button>
                        </form>
                    </div>
                    <div class="hd_crtl flex items-center">
                        <div class="shrink-0 mx-3 hover:text-secondary">
                            <a href=""><i class="fa-regular fa-user text-[24px]"></i></a>
                        </div>
                        <div class="shrink-0 mx-3 relative hover:text-secondary hover:text-secondary">
                            <a href=""><i class="fa-regular fa-heart text-[24px]"></i></a>
                            <span class="absolute top-[-9px] right-[-8px] w-5 h-5 flex items-center justify-center rounded-full bg-[#f1f8e9] text-primary">0</span>
                        </div>
                        <div class="shrink-0 mx-3 flex btn_box__tranform hover:text-secondary hover:cursor-pointer">
                            <div class="relative mr-3">
                                <ion-icon name="cart-outline" class="text-[27px]"></ion-icon>
                                <span class="absolute top-[-6px] right-[-8px] w-5 h-5 flex items-center justify-center rounded-full bg-[#f1f8e9] text-primary">0</span>
                            </div>

                            <div class="hidden lg:block">0.00 VND</div>
                        </div>
                        <div class="shrink-0 ml-3 lg:hidden">
                            <i class="fa-solid fa-bars text-[24px] btn_nav__mobile hover:text-primary hover:cursor-pointer"></i>
                        </div>
                    </div>
                </div>
                <div class="header_bottom hidden lg:flex px-40 w-full h-[60px]  items-center justify-between bg-primary text-white">
                    <div class="flex">
                        <div class="dropdown h-[60px]">
                            <button class="dropbtn w-[230px] h-[45px] px-5 rounded-lg bg-secondary flex items-center justify-between">
                                <i class="fa-solid fa-bars"></i>
                                <span>Phan loai</span>
                                <i class="fa-solid fa-chevron-down"></i>
                            </button>
                            <div class="dropdown-content shadow-lg bg-white text-black absolute top-[60px] w-[230px] p-3 rounded-b-lg">
                                <a class="py-1 hover:text-primary" href="#">Link 1</a>
                                <a class="py-1 hover:text-primary" href="#">Link 2</a>
                                <a class="py-1 hover:text-primary" href="#">Link 3</a>
                            </div>
                        </div>
                        <nav>
                            <ul class="flex items-center h-[60px] px-3">
                                <li><a class="px-3 hover:text-secondary" href="#">Trang chủ</a></li>
                                <li><a class="px-3 hover:text-secondary" href="#">Sản phẩm</a></li>
                                <li><a class="px-3 hover:text-secondary" href="#">Bài viết</a></li>
                                <li><a class="px-3 hover:text-secondary" href="#">Liên hệ</a></li>
                                <li><a class="px-3 hover:text-secondary" href="#">Chúng tôi</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div>
                ...
                <div class="header_search__mobile lg:hidden w-full h-[55px] bg-primary flex items-center justify-center px-6">
                    <div class="relative w-full">
                        <input type="text" class="w-full pl-3 pr-9 py-2 rounded-lg outline-none">
                        <i class="fa-solid fa-magnifying-glass absolute top-2 right-2 text-2xl font-bold hover:text-primary"></i>
                    </div>
                </div>

                <!-- Start header scroll -->
                <div class="header_scroll hidden lg:block w-full h-[70px] fixed top-0 z-20 translate-y-[-1000px] bg-white border-b">
                    <div class="flex header_scroll__big lg:px-40 items-center justify-between h-full">
                        <div class="flex items-center">
                            <div>
                                <img src="https://images.pexels.com/photos/19202326/pexels-photo-19202326/free-photo-of-dolomite-y.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" class="h-[60px] w-[60px]">
                            </div>
                            <nav>
                                <ul class="flex items-center h-[60px] px-3">
                                    <li><a class="px-3" href="#">Trang chủ</a></li>
                                    <li><a class="px-3" href="#">Sản phẩm</a></li>
                                    <li><a class="px-3" href="#">Bài viết</a></li>
                                    <li><a class="px-3" href="#">Liên hệ</a></li>
                                    <li><a class="px-3" href="#">Chúng tôi</a></li>
                                </ul>
                            </nav>
                        </div>
                        <div class="flex items-center header_scroll__nav">
                            <div class="shrink-0 mx-3 hover:text-primary hover:cursor-pointer">
                                <i class="btn_ctrl__hd-sc fa-solid fa-magnifying-glass text-[24px]"></i>
                            </div>
                            <div class="shrink-0 mx-3 hover:text-primary">
                                <a href=""><i class="fa-regular fa-user text-[24px]"></i></a>
                            </div>
                            <div class="shrink-0 mx-3 relative hover:text-primary">
                                <a href=""><i class="fa-regular fa-heart text-[24px]"></i></a>
                                <span class="absolute top-[-9px] right-[-8px] w-5 h-5 flex items-center justify-center rounded-full bg-[#f1f8e9] text-primary">0</span>
                            </div>
                            <div class="shrink-0 mx-3 flex btn_box__tranform hover:text-primary hover:cursor-pointer">
                                <div class="relative mr-3">
                                    <ion-icon name="cart-outline" class="text-[27px]"></ion-icon>
                                    <span class="absolute top-[-6px] right-[-8px] w-5 h-5 flex items-center justify-center rounded-full bg-[#f1f8e9] text-primary">0</span>
                                </div>
                    ...
                    <div class=" h-full w-full header_scroll__input hidden">
                        <div class="flex items-center justify-center w-full h-full lg:px-40">
                            <form action="" class="w-full relative">
                                <input autofocus="" type="text" class="w-full py-3 pl-3 pr-6 outline-none" placeholder="Search here">
                                <div class="absolute top-[10px] rounded-full right-[0px] h-7 w-7 bg-primary text-white hover:cursor-pointer hover:bg-secondary flex items-center justify-center">
                                    <i class="fa-solid fa-xmark  text-[24px] header_scroll__input-closed"></i>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="lg:hidden" role="dialog" aria-modal="true">
                    ...
                    <div class="nav_menu__mobile  fixed inset-y-0 right-0 z-10 w-11/12 overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                        <div class="flex items-center justify-between">
                            <a href="#" class="-m-1.5 p-2.5">
                                <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="">
                            </a>
                            <button type="button" class="-m-2.5 rounded-md p-2.5 text-primary hover:text-secondary font-bold">
                                <span class="sr-only">Close menu</span>
                                <svg class="h-6 w-6 btn_closed_nav-mobile" fill="none" viewbox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        ...
                        <div class="mt-6 flow-root">
                            <div class="-my-6 divide-y divide-gray-500/10">
                                <div class="space-y-2 py-6">
                                    <div class="-mx-3 h-auto truncate">
                                        <button type="button" class="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50" aria-controls="disclosure-1" aria-expanded="false">
                                            Product
                                            <svg class="h-5 w-5 flex-none btn_disclosure" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd"></path>
                                            </svg>
                                        </button>
                                        <div class="mt-2 space-y-2 h-auto" id="disclosure-1">
                                ...
                                <div class="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5">
                                    <div class="shrink-0 mx-3 hover:text-primary rounded-lg w-16 h-12 flex items-center border justify-center">
                                        <a href=""><i class="fa-regular fa-user text-[24px] "></i></a>

                                    </div>
                                    <div class="shrink-0 mx-3 hover:text-primary rounded-lg w-16 h-12 flex items-center border justify-center relative">
                                        <a href=""><i class="fa-regular fa-heart text-[24px]"></i></a>
                                        <span class="absolute top-[3px] right-[10px] w-5 h-5 flex items-center justify-center rounded-full bg-[#f1f8e9] text-primary">0</span>
                                    </div>
                                    <div class="shrink-0 mx-3 hover:text-primary rounded-lg w-16 h-12 flex items-center border justify-center btn_box__tranform">
                                        <div class="relative">
                                            <ion-icon name="cart-outline" class="text-[24px]"></ion-icon>
                                            <span class="absolute top-[-5px] right-[-8px] w-5 h-5 flex items-center justify-center rounded-full bg-[#f1f8e9] text-primary">0</span>
                                        </div>

                                        <div class="hidden lg:block">0.00 VND</div>
                                    </div>
                                </div>
                                <a href="#" class="w-full rounded-lg py-2 pl-3 pr-3.5 flex items-center justify-center bg-primary text-white my-4 text-base hover:bg-[#698141]">Features</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="w-full lg:px-40 px-4 lg:mt-10 mt-[120px] lg:py-0 py-8">
            <div class="flex gap-5 flex-col lg:flex-row">
                <div class="basis-1/2 ">
                    <form orm="" action="">
                        <p class="text-2xl font-bold mb-4">Thông tin liên hệ</p>
                        <div class="mb-6">
                            <label for="">Email</label><br>
                            <input class="rounded-lg w-full p-2 border-primary focus:border-secondary border outline-none" type="email" name="" id="">
                        </div>
                        <hr class="h-[2px]">
                        <p class="text-2xl font-bold mb-4 mt-4">Thông tin vận chuyển</p>
                        <div class="mb-4">
                            <label for="">Họ và tên</label>
                            <input class="rounded-lg w-full p-2 border-primary focus:border-secondary border outline-none" type="text" name="">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="" id="" cols="30" rows="4" class="w-full border border-primary rounded-lg outline-none p-2"></textarea>
                        </div>
                        <div class="flex gap-2 mb-6">
                            <div class="basis-1/3">
                                <label for="countries" class="block  dark:text-white">Tỉnh</label>
                                <select id="countries" class="bg-gray-50 border border-primary text-gray-900 text-sm rounded-lg focus:ring-secondary focus:border-secondary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <div class="basis-1/3">
                                <label for="countries" class="block dark:text-white">Huyện</label>
                                <select id="countries" class="bg-gray-50 border border-primary text-gray-900 text-sm rounded-lg focus:ring-secondary focus:border-secondary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected="">Choose a country</option>
                                    <option value="US">United States</option>
                                    <option value="CA">Canada</option>
                            ...
                            <div class="basis-1/3">
                                <label for="countries" class="block dark:text-white">Xã</label>
                                <select id="countries" class="bg-gray-50 border border-primary text-gray-900 text-sm rounded-lg focus:ring-secondary focus:border-secondary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected="">Choose a country</option>
                                    <option value="US">United States</option>
                                    <option value="CA">Canada</option>
                        ...
                        <div>
                            <ul class="grid w-full gap-6 md:grid-cols-2">
                                <li>
                                    ...
                                    <label for="hosting-small" class="inline-flex h-[90px] items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-primary peer-checked:border-primary peer-checked:text-primary hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <div class="block">
                                            <div class="w-full">Thanh toán khi nhận hàng</div>
                                        </div>
                                ...
                                <li>
                                    ...
                                    <label for="hosting-big" class="inline-flex h-[90px] items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-primary peer-checked:border-primary peer-checked:text-primary hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <div class="block">
                                            <div class="w-full">Thanh toán online</div>
                                        </div>
                                        <svg class="w-5 h-5 ms-3 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 14 10">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"></path>
                                        </svg>
                ...
                <div class="basis-1/2">
                    <p class="text-2xl font-bold mb-4">Đơn hàng</p>
                    <div>
                    ...
                    <div class="bg-white p-4 rounded-lg border">
                        <div>
                            <div class="flex items-center justify-between py-3">
                                <div class="flex items-center">
                                    <div class="h-[120px] w-20 rounded-lg bg-[#f1f8e9] overflow-hidden mr-3">
                                        <img src="/s3qqpek5.0e773528.png" alt="" class="w-full h-full object-cover">
                                    </div>
                                    <div>
                                        <p class="mb-2">Vlahc ewesd</p>
                                        <div class="text-sm">100.000 VND</div>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="text-center">
                                <button class="rounded-lg bg-primary text-white hover:bg-secondary w-full h-12">Đặt
                                    hàng</button>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="bg-secondary mt-10">
            <div class=" space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-40">
                    ...
                    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <ul class="mt-6 space-y-4 text-sm">
                                ...
                                <li>
                                    <a href="#" class="text-white transition hover:opacity-75"> Hiring Statistics
                                    </a>
                                </li>
                            </ul>
                        </div>
        ...
        <!-- Start Cart -->
        <div class="fixed hidden inset-0 bg-gray-500 bg-opacity-75 transition-opacity z-10 box_tranform-overplay">
        </div>
        <div class="relative z-10 " aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
            <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 box_tranform">
                <div class="pointer-events-auto w-screen max-w-md">
                    <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                        <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                            <div class="flex items-start justify-between">
                                ...
                                <div class="ml-3 flex h-7 items-center">
                                    <button type="button" class="btn_closed__box-tranfrom relative -m-2 p-2 text-gray-400 hover:text-gray-500">
                        ...
                        <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                            ...
                            <div class="mt-6">
                                <a href="#" class="flex items-center justify-center rounded-md border border-transparent bg-primary px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-secondary">Checkout</a>
                            </div>
...
<script src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js" defer=""></script>
<script nomodule="" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"></script>
<script src="/admin_category.686a4276.js"></script>
<script src="https://unpkg.com/scrollreveal"></script>
<script src="/admin_category.4a01a4e5.js"></script>
<script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>
<script src="/admin_category.a63a3019.js"></script>
